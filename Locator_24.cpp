...
void loop() {
    ...
    // +Accel
    // -Geo
    if ((averageSpeedLevel3 >= speedThreshhold) && (assetAccellXYZ >= accellThreshhold) && (geoFenceDistance >= geoThreshhold)){ 
    ...
    // +Accel
    // -Geo
    else if ((averageSpeedLevel3 < speedThreshhold) && (assetAccellXYZ >= accellThreshhold) && (geoFenceDistance >= geoThreshhold)){ 
